...
/// Explicit skeleton demo: [FastShimmer] switches placeholder vs content.
/// 显式骨架演示：用 [FastShimmer] 在占位与真实内容之间切换。
class ShimmerSkeletonExample extends StatefulWidget {
  const ShimmerSkeletonExample({super.key});

  @override
  State<ShimmerSkeletonExample> createState() => _ShimmerSkeletonExampleState();
}

class _ShimmerSkeletonExampleState extends State<ShimmerSkeletonExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Shimmer · Skeleton'),
        actions: [
          IconButton(
            tooltip: 'Reload',
